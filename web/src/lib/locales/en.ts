export default {
  ...
  'newSession.noMachinesNativeHint': 'No runner machines are online right now. You can still attach a tmux codex pane below, which creates a native HAPI session.',
  'nativeSession.title': 'Attach Native Session',
  'nativeSession.description': 'Reuse an existing tmux pane running codex and create a native HAPI session for it.',
  'nativeSession.createTitle': 'Create New Native Session',
  'nativeSession.createDescription': 'Start a new tmux session in the chosen directory, launch codex, and attach it to HAPI automatically.',
  'nativeSession.directoryLabel': 'Directory',
  'nativeSession.directoryPlaceholder': '/path/to/project',
  'nativeSession.titleLabel': 'Name (optional)',
  ...
  'nativeSession.create': 'Create Native Session',
  'nativeSession.creating': 'Creating…',
