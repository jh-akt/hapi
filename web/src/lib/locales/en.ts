export default {
  ...
  'session.action.model': 'Model',
  'session.action.modelUnavailable.native': 'Local tmux session has been retired',
  'session.action.modelUnavailable.offline': 'Session is offline; resume it remotely to change model',
  'session.action.modelUnavailable.unsupported': 'This session does not support model changes',
  ...
  'dialog.model.title': 'Session Model',
  'dialog.model.description': 'Choose the model used by future messages in this session.',
  'dialog.model.saving': 'Saving…',
  'dialog.model.error': 'Failed to update model. Please try again.',
  ...
  'newSession.noMachinesHint': 'No runner machines are online right now. Start the HAPI runner on a machine, then create a remote Codex session.',
  'nativeSession.badge': 'native',
  'project.empty': 'This project does not have any sessions yet. Start a remote Codex session from an online runner.',
  ...
  'codexPanel.tab.messages': 'Messages',
  'codexPanel.tab.summary': 'Summary',
  'codexPanel.tab.review': 'Review',
  'codexPanel.tab.manage': 'Manage',
  'codexPanel.messages.count': 'Messages',
  'codexPanel.messages.empty': 'No message data yet.',
  'codexPanel.messages.loadFailed': 'Failed to load message data.',
