export default {
  ...
  'sessions.showArchived': 'Archived ({n})',
  'sessions.showActive': 'Active',
  'sessions.empty.active': 'No sessions yet.',
  ...
  'session.action.rollback': 'Rollback',
  'session.action.compact': 'Compact',
  'session.action.archive': 'Archive',
  'session.action.unarchive': 'Restore',
  'session.action.newInDirectory': 'New session here',
  ...
  'dialog.archive.description': 'Are you sure you want to archive "{name}"? Archived sessions are hidden from the default list, and active sessions will be disconnected.',
  'dialog.archive.confirm': 'Archive',
  'dialog.archive.confirming': 'Archiving…',
  'dialog.archiveCodexThread.title': 'Archive Thread',
  'dialog.archiveCodexThread.description': 'Archive "{name}" from Codex history? You can restore it later from the archived list.',
  'dialog.archiveCodexThread.confirm': 'Archive',
  'dialog.archiveCodexThread.confirming': 'Archiving…',
  'dialog.rollbackCodexThread.title': 'Rollback Thread',
  'dialog.rollbackCodexThread.description': 'Choose how many recent turns to remove from this Codex thread.',
  'dialog.rollbackCodexThread.turns': 'Turns',
  'dialog.rollbackCodexThread.turnOption': '{n} turn(s)',
  'dialog.rollbackCodexThread.loading': 'Loading turns…',
  'dialog.rollbackCodexThread.loadFailed': 'Failed to load turns.',
  'dialog.rollbackCodexThread.confirm': 'Rollback',
  'dialog.rollbackCodexThread.confirming': 'Rolling back…',
  'dialog.compactCodexThread.title': 'Compact Thread',
  'dialog.compactCodexThread.description': 'Start context compaction for "{name}"? The thread will keep running while Codex prepares a compacted context.',
  'dialog.compactCodexThread.confirm': 'Compact',
  'dialog.compactCodexThread.confirming': 'Starting…',
  'dialog.unarchive.title': 'Restore Archived Session',
  'dialog.unarchive.description': 'Restore "{name}" to the default list?',
  ...
  'newSession.noMachinesNativeHint': 'No runner machines are online right now. You can still create a project below to load existing native codex sessions in that directory, or attach a tmux codex pane directly.',
  'nativeSession.title': 'Native Codex Projects',
  'nativeSession.description': 'Create a project first, then automatically load existing native codex sessions in that directory. If a codex tmux pane is already running, you can attach it directly too.',
  'nativeSession.createTitle': 'Create Project',
  'nativeSession.createDescription': 'Save a project directory and immediately load existing native codex sessions from it. If there are no sessions yet, the project still appears in the list.',
  'nativeSession.directoryLabel': 'Directory',
  'nativeSession.directoryPlaceholder': '/path/to/project',
  'nativeSession.titleLabel': 'Project name (optional)',
  'nativeSession.titlePlaceholder': 'project-name',
  'nativeSession.refresh': 'Refresh',
  'nativeSession.loading': 'Discovering tmux panes…',
  'nativeSession.loadError': 'Failed to discover native sessions.',
  'nativeSession.empty': 'No attachable codex tmux panes found.',
  'nativeSession.create': 'Create Project',
  'nativeSession.creating': 'Creating project…',
  'nativeSession.attach': 'Attach Existing Pane',
  'nativeSession.attaching': 'Attaching…',
  'nativeSession.attached': 'Attached',
  'nativeSession.open': 'Open',
  'nativeSession.badge': 'native',
  'project.empty': 'This project does not have any sessions yet. Attach an existing pane or start codex in that directory later.',
  ...
  'codexPanel.tab.summary': 'Summary',
  'codexPanel.tab.review': 'Review',
  'codexPanel.tab.manage': 'Manage',
  'codexPanel.summary.name': 'Name',
  'codexPanel.summary.status': 'Status',
  'codexPanel.summary.modelProvider': 'Model',
  'codexPanel.summary.effort': 'Effort',
  'codexPanel.summary.turns': 'Turns',
  'codexPanel.summary.cwd': 'Workspace',
  'codexPanel.summary.updatedAt': 'Updated',
  'codexPanel.summary.cliVersion': 'Codex CLI',
  'codexPanel.summary.git': 'Git',
  'codexPanel.summary.turnList': 'Turn list',
  'codexPanel.summary.loadFailed': 'Failed to load thread summary.',
  'codexPanel.summary.turnsFailed': 'Failed to load turns.',
  'codexPanel.review.thread': 'Review thread',
  'codexPanel.review.clear': 'Clear',
  'codexPanel.review.empty': 'No review thread yet. Send /review to start a structured Codex review.',
  'codexPanel.review.noRows': 'No review output yet.',
  'codexPanel.review.loadFailed': 'Failed to load review output.',
  'codexPanel.review.started': 'Review started',
  'codexPanel.review.failed': 'Review failed',
  'codexPanel.manage.skills': 'Skills',
  'codexPanel.manage.plugins': 'Plugins',
  'codexPanel.manage.apps': 'Apps',
  'codexPanel.manage.mcp': 'MCP',
  'codexPanel.manage.memory': 'Memory',
  'codexPanel.manage.tools': 'tools',
  'codexPanel.manage.resources': 'resources',
  'codexPanel.manage.enabled': 'enabled',
  'codexPanel.manage.disabled': 'disabled',
  'codexPanel.manage.install': 'Install',
  'codexPanel.manage.uninstall': 'Uninstall',
  'codexPanel.manage.empty': 'Nothing to show.',
  'codexPanel.manage.loadFailed': 'Failed to load this panel.',
  'codexPanel.manage.pluginInstalled': 'Plugin installed',
  'codexPanel.manage.pluginUninstalled': 'Plugin uninstalled',
  'codexPanel.manage.pluginFailed': 'Plugin action failed',
  'codexPanel.manage.memoryEnable': 'Enable memory',
  'codexPanel.manage.memoryDisable': 'Disable memory',
  'codexPanel.manage.memoryReset': 'Reset memory',
  'codexPanel.manage.memoryEnabled': 'Memory enabled',
  'codexPanel.manage.memoryDisabled': 'Memory disabled',
  'codexPanel.manage.memoryUpdated': 'Memory mode updated',
  'codexPanel.manage.memoryFailed': 'Memory action failed',
  'codexPanel.manage.memoryResetConfirm': 'Reset Codex memory for this account?',
  'codexPanel.manage.memoryResetDone': 'Memory reset',
  'codexPanel.manage.memoryResetDoneBody': 'Codex memory was reset.',
