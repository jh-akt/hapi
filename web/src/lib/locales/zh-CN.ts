export default {
  ...
  'session.action.model': '模型',
  'session.action.modelUnavailable.native': '本地 tmux 会话已停用',
  'session.action.modelUnavailable.offline': '会话离线，恢复为远程会话后可改',
  'session.action.modelUnavailable.unsupported': '此会话不支持切换模型',
  ...
  'dialog.model.title': '会话模型',
  'dialog.model.description': '选择这个会话后续消息使用的模型。',
  'dialog.model.saving': '保存中…',
  'dialog.model.error': '更新模型失败，请重试。',
  ...
  'newSession.noMachinesHint': '当前没有在线 runner 机器。请先启动 HAPI runner，再创建远程 Codex session。',
  'nativeSession.badge': '原生',
  'project.empty': '这个项目下还没有 session。请从在线 runner 创建远程 Codex session。',
  ...
  'codexPanel.tab.messages': '消息',
  'codexPanel.tab.summary': '线程摘要',
  'codexPanel.tab.review': 'Review 展示',
  'codexPanel.tab.manage': '管理面板',
  'codexPanel.messages.count': '消息数',
  'codexPanel.messages.empty': '暂无消息数据。',
  'codexPanel.messages.loadFailed': '读取消息数据失败。',
